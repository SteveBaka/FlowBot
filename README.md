...
镜像内置 Linux Weixin v4.1.1.8  + WeFlow v4.5.1 (支持消息发送的修改版本) + noVNC 力求做到开箱即用的体验。

> ⚠️请不要在**任何互联网、社交平台**提到本项目以及相关延伸项目，否则即时停止项目维护和部署。
> ⚠️免责声明：FlowBot 旨在提供了一个能够让用户**学习并研究**能够与AI机器人进行聊天的协议，并且所有内容均在本地和对应部署的项目进行，开发者不收集任何隐私和安全信息。
